...
>
	<div class="absolute inset-0 bg-black/50" @click.stop="sizeChartOpen = false"></div>
	...
	<div class="relative bg-white w-full md:max-w-2xl max-h-[85vh] overflow-y-auto rounded-t-2xl md:rounded-sm p-6 md:p-8 text-right">
		...
		<button type="button" class="btn btn--outline w-full mt-6" @click.stop="sizeChartOpen = false">
